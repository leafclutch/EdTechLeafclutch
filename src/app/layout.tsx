...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "tech job Nepal",
    "AI training Nepal",
    "web development program Nepal",
    "cybersecurity training Nepal",
    "UI UX design program Nepal",
    "graphic design training Nepal",
    "data science program Nepal",
  ...
  twitter: {
    ...
    description:
      "Nepal's leading IT training & internship provider. AI, Web Dev, Cybersecurity, UI/UX, Graphic Design & Data Science programs in Bhairahawa & Butwal.",
    images: ["/og-image.png"],
  },
  robots: {
    index: true,
